...
<br>cummulative returns APPL: round(100*sum(StockReturns[,2]),1) = 596.5%
<br>avarerage daily returns APPL: round(100*mean(StockReturns[,2]),3) = 0.148%
<br>standard deviation AAPL: round(100*sd(StockReturns[,2]),3) = 2.39%

<hr>mytickers = c("SPY", "AAPL", "GOOG", "YHOO")
<hr>
...
**Your Answers here:**
<br> transposedData: dim(t(StockReturns)) = 2 4030 ; meaning 2 rows and 4030 columns
<br> portfolio = apply(StockReturns,1,mean)
...
**Your Answers here:**
<br> startDate = "2001-01-01"
<br>mytickers = c("SPY", "AAPL", "GOOG", "YHOO")
<br>> portfolio = apply(StockReturns,1,mean)
<br>names(portfolio) <- rownames(StockReturns)

<hr>pnl_plot(portfolio)
<hr>
...
**Your Answers here:**
<br>sum(myData) = 20
<br>false because you are adding a list (myData) with a vector/table (stockreturns)
<br>
<br>
